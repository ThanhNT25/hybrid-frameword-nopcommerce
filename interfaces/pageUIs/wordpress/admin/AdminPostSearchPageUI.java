...
public class AdminPostSearchPageUI {
	...
	public static final String SEARCH_BUTTON  = "css=#search-submit";
	...
	public static final String TITLE_POST_LINK = "xpath=//table[contains(@class,'table-view-list posts')]/tbody/tr//a[@class='row-title' and text()='%s']";
	public static final String ROW_CHECKBOX_BY_TITLE_NAME ="xpath=//table[contains(@class,'table-view-list posts')]/tbody/tr//a[@class='row-title' and text()='%s']/ancestor::td/preceding-sibling::th//input";
